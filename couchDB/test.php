<?php
	...
	if ($couch->isConnected)
	{
		...
		$attachment['path'] = '/home/osene/cloud/svn/csa/doc/Facturation/app/modules/couchDB/couchDB2.txt';
		$attachment['name'] = 'couchDB.txt';
		echo 'Updating last attachment ', "\n";
		$documentInfo = $couch->addAttachment('test', $couch->lastResult['id'], $couch->lastResult['rev'], $attachment);
		print_r($documentInfo);
		...
		$attachment['path'] = '/home/osene/cloud/svn/csa/doc/Facturation/app/modules/couchDB/couchDB2.txt';
		$attachment['name'] = 'couchDB.txt';
		echo 'deleting last attachment ', "\n";
		$documentInfo = $couch->deleteAttachment('test', $couch->lastResult['id'], $couch->lastResult['rev'], $attachment);
		print_r($documentInfo);
