...
class __Mustache_69bc15a2a3e12d8d112d939e98dd0ace extends Mustache_Template
{
...
';
        $buffer .= $indent . '                        <!--<p><input type="button" value="🔊 Radio"/></p>-->
';
        $buffer .= $indent . '                        <nav class="categoryFilter">
';
        $buffer .= $indent . '                            <ul class="pagination pagination-sm">
';
        $buffer .= $indent . '                                <li><a href="#"><img src="img/icones/anonymous/anonymous50.png" id="anonymous" class="btn-primary icones" data-toggle="tooltip" data-placement="bottom" title="Articles anonymes" data-bind="click:myFilter(\'category\', \'anonymous\')"/><p class="with-badge"><span class="badge" data-bind="text: nbArticles().anonymous"></span></p></a></li>
';
        $buffer .= $indent . '                                <li><a href="#"><img src="img/icones/culture/culture50.png" id="culture" class="icones" data-toggle="tooltip" data-placement="bottom" title="Articles culturels" data-bind="click:myFilter(\'category\', \'culture\')"/><p class="with-badge"><span class="badge" data-bind="text: nbArticles().culture"></span></p></a></li>
';
        $buffer .= $indent . '                                <li><a href="#"><img src="img/icones/economic/economic50.png" id="economic" class="icones" data-toggle="tooltip" data-placement="bottom" title="Articles economique" data-bind="click:myFilter(\'category\', \'economic\')"/><p class="with-badge"><span class="badge" data-bind="text: nbArticles().economic"></span></p></a></li>
';
        $buffer .= $indent . '                                <li><a href="#"><img src="img/icones/international/internat50.png" id="international" class="icones" data-toggle="tooltip" data-placement="bottom" title="Articles internationaux" data-bind="click:myFilter(\'category\', \'international\')"/><p class="with-badge"><span class="badge" data-bind="text: nbArticles().international"></span></p></a></li>
';
        $buffer .= $indent . '                                <li><a href="#"><img src="img/icones/mynews/mynews50.png" id="mynews" class="icones" data-toggle="tooltip" data-placement="bottom" title="My news" data-bind="click:myFilter(\'category\', \'mynews\')"/><p class="with-badge"><span class="badge" data-bind="text: nbArticles().mynews"></span></p></a></li>
';
        $buffer .= $indent . '                                <li><a href="#"><img src="img/icones/national/national50.png" id="national" class="icones" data-toggle="tooltip" data-placement="bottom" title="Articles nationaux" data-bind="click:myFilter(\'category\', \'national\')"/><p class="with-badge"><span class="badge" data-bind="text: nbArticles().national"></span></p></a></li>
';
        $buffer .= $indent . '                                <li><a href="#"><img src="img/icones/newstudents/newsstudents50.png" id="newstudents" class="icones" data-toggle="tooltip" data-placement="bottom" title="News etudiants" data-bind="click:myFilter(\'category\', \'newstudents\')"/><p class="with-badge"><span class="badge" data-bind="text: nbArticles().newstudents"></span></p></a></li>
';
        $buffer .= $indent . '                                <li><a href="#"><img src="img/icones/numeric/numeric50.png" id="numeric" class="icones" data-toggle="tooltip" data-placement="bottom" title="Articles numériques" data-bind="click:myFilter(\'category\', \'numeric\')"/><p class="with-badge"><span class="badge" data-bind="text: nbArticles().numeric"></span></p></a></li>
';
        $buffer .= $indent . '                                <li><a href="#"><img src="img/icones/politic/politic50.png" id="politic" class="icones" data-toggle="tooltip" data-placement="bottom" title="Articles politiques" data-bind="click:myFilter(\'category\', \'politic\')"/><p class="with-badge"><span class="badge" data-bind="text: nbArticles().politic"></span></p></a></li>
';
        $buffer .= $indent . '                                <li><a href="#"><img src="img/icones/science/science50.png" id="science" class="icones" data-toggle="tooltip" data-placement="bottom" title="Articles scientifiques" data-bind="click:myFilter(\'category\', \'science\')"/><p class="with-badge"><span class="badge" data-bind="text: nbArticles().science"></span></p></a></li>
';
        $buffer .= $indent . '                                <li><a href="#"><img src="img/icones/society/society50.png" id="society" class="icones" data-toggle="tooltip" data-placement="bottom" title="Articles sociétales" data-bind="click:myFilter(\'category\', \'society\')"/><p class="with-badge"><span class="badge" data-bind="text: nbArticles().society"></span></p></a></li>
';
        $buffer .= $indent . '                                <li><a href="#"><img src="img/icones/sports/sports50.png" id="sport" class="icones" data-toggle="tooltip" data-placement="bottom" title="Articles sports" data-bind="click:myFilter(\'category\', \'sport\')"/><p class="with-badge"><span class="badge" data-bind="text: nbArticles().sports"></span></p></a></li>
';
        $buffer .= $indent . '                            </ul>
';
        $buffer .= $indent . '                        </nav>
...
';
        $buffer .= $indent . '                        <li><a href="#" data-bind="click: toggleRadio">🔊 Radio</a></li>
';
        $buffer .= $indent . '                      </ul>
';
        $buffer .= $indent . '                      <ul class="nav navbar-nav navbar-right myFilters">
';
        $buffer .= $indent . '                          <form class="navbar-form">
';
        $buffer .= $indent . '                            <div class="form-group col-sm-3">
';
        $buffer .= $indent . '                                <label for="showReaded">Voir lus: <input type="checkbox" id="showReaded"/></label>
';
        $buffer .= $indent . '                            </div>
';
        $buffer .= $indent . '                            <div class="form-group col-sm-3">
...
';
        $buffer .= $indent . '                            <div class="form-group col-sm-3">
';
        $buffer .= $indent . '                              <input type="text" class="form-control" placeholder="Rechercher" data-bind="value: articles().articleTitleFilter, valueUpdate: \'keyup\'">
';
        $buffer .= $indent . '                            </div>
';
        $buffer .= $indent . '                          </form>
...
';
        $buffer .= $indent . '                                <div class="gallery-items" data-bind="click: $root.showArticleDetails.bind($data, $index())">
';
...
';
        $buffer .= $indent . '                        </span>
';
        $buffer .= $indent . '                        <p data-bind="if: !hasArticles()" class="text-center">
';
        $buffer .= $indent . '                            Il n\'y a pas d\'articles disponible veuillez enlever certains filtres ou changer de catégorie.
';
        $buffer .= $indent . '                        </p>
';
        $buffer .= $indent . '                    </div>
...
';
        $buffer .= $indent . '            <div class="container">
';
        $buffer .= $indent . '                <h2>L\'actu c\'est vous qui la faîtes avec <b>My Actually</b>!</h2>
';
        $buffer .= $indent . '                
';
        $buffer .= $indent . '                <p><h3><b>L\'actualité de différents média sur une seule interface...</b></h3> <br>
';
        $buffer .= $indent . '                
';
        $buffer .= $indent . '                Faire de l\'actualité un moyen de communautarisme. <br>
';
        $buffer .= $indent . '                Pouvoir se partager les articles lus, créer des articles et éventuellement commenter "intelligemment". <br>
';
        $buffer .= $indent . '                Donner son avis et faire de cette nouvelle plateforme un moyen de prendre la parole facilement et d\'être un porte-parole. <br>
';
        $buffer .= $indent . '                Avoir les articles triés par la communauté par thème. <br>
';
        $buffer .= $indent . '                Des alertes par rapport à l\'actualité. (un suivi ...) <br>
';
        $buffer .= $indent . '                Création de chaines afin d\'être suivis par des utilisateurs. <br>
';
        $buffer .= $indent . '                </p>
';
        $buffer .= $indent . '                <div class="wowload fadeInUp social"><a href="https://www.facebook.com/myactually/?ref=hl"><i class="fa fa-facebook fa-2x"></i></a> <a href="#"><i class="fa fa-instagram fa-2x"></i></a> <a href="#"><i class="fa fa-twitter fa-2x"></i></a> <a href="#"><i class="fa fa-flickr fa-2x"></i></a> </div>
';
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '            </div>
...
';
        $buffer .= $indent . '                    <span class=\'description\'>Publie le <span data-bind="text: date"></span></span>
';
        $buffer .= $indent . '                  </div><!-- /.user-block -->
';
...
';
        $buffer .= $indent . '                      <h4 class="attachment-heading"><a data-bind="text: h3, attr: {href: link}" target="_blank"></a></h4>
';
...
';
        $buffer .= $indent . '                  <span data-bind="if: $root.canComment()">
';
...
';
        $buffer .= $indent . '                  </span>
';
        $buffer .= $indent . '                  <span class=\'pull-right text-muted\'>45 likes - 2 commentaires - <span data-bind="text: views"></span> Vues</span>
';
        $buffer .= $indent . '                </div><!-- /.box-body --
';
...
';
        $buffer .= $indent . '                </div><!-- /.box-footer -->
';
        $buffer .= $indent . '                <div class="box-footer" data-bind="if: $root.canComment()">
';
        $buffer .= $indent . '                    <p>Tout commentaire contraire à la réglementation en vigueur (et notamment tout commentaire à caractère raciste, antisémite ou diffamatoire) pourra donner lieu à la suppression de votre compte My Actually.<br/>Le cas échéant, certains commentaires que vous postez pourront également donner lieu à des poursuites judiciaires à votre encontre.</p>
';
        $buffer .= $indent . '                  <form>
';
...
';
        $buffer .= $indent . '                                        <div class="col-sm-10">
';
        $buffer .= $indent . '                                            <input class="form-control" id="country" placeholder="France" type="text" data-bind="value: country">
';
        $buffer .= $indent . '                                        </div>
';
        $buffer .= $indent . '                                    </div>
...
';
        $buffer .= $indent . '                                <div class="box-footer">
';
        $buffer .= $indent . '                                    <p>Nous allons rechercher l\'ensemble des articles par rapport à votre position.</p>
';
        $buffer .= $indent . '                                    <button type="button" class="btn btn-info pull-right" data-bind="click: $parent.initialSearch">Chercher</button>
';
        $buffer .= $indent . '                                </div><!-- /.box-footer -->
';
        $buffer .= $indent . '                            </form>
...
';
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '        <script src="assets/jquery.js"></script>
';
        $buffer .= $indent . '        <script src="assets/jquery-ui.js"></script>
';
        $buffer .= $indent . '        <script src="assets/wow/wow.min.js"></script>
';
        $buffer .= $indent . '        <script src="assets/slidingheader/classie.js"></script>
';
        $buffer .= $indent . '        <script src="assets/bootstrap/js/bootstrap.js" type="text/javascript" ></script>
';
        $buffer .= $indent . '        <script src="assets/mobile/touchSwipe.min.js"></script>
';
        $buffer .= $indent . '        <script src="assets/respond/respond.js"></script>
';
        $buffer .= $indent . '        <script src=\'https://code.responsivevoice.org/responsivevoice.js\'></script>
';
        $buffer .= $indent . '        <script src="assets/dist/js/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
';
        $buffer .= $indent . '        <script src="assets/pouchdb-5.3.1.min.js"></script>
';
        $buffer .= $indent . '        <script src="assets/knockout-3.4.0.js"></script>
';
        $buffer .= $indent . '        <script src="assets/locator.js"></script>
';
        $buffer .= $indent . '        <script src="assets/user.js"></script>
';
        $buffer .= $indent . '        <script src="assets/article.js"></script>
';
        $buffer .= $indent . '        <script src="assets/myActually.js"></script>
';
        $buffer .= $indent . '        <script src="assets/script.js"></script>
';
        $buffer .= $indent . '        <script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
';
        $buffer .= $indent . '            <!-- Adsense -->
';
        $buffer .= $indent . '            <script>
';
        $buffer .= $indent . '            (adsbygoogle = window.adsbygoogle || []).push({});
';
        $buffer .= $indent . '        </script>
';
        $buffer .= $indent . '    </body>
