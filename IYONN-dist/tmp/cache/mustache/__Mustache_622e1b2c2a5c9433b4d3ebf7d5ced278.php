...
class __Mustache_622e1b2c2a5c9433b4d3ebf7d5ced278 extends Mustache_Template
{
...
';
        $buffer .= $indent . '                                <li><a href="#"><img src="img/icones/anonymous/anonymous50.png" class="icones" data-toggle="tooltip" data-placement="bottom" title="Articles anonymes"/></a></li>
';
        $buffer .= $indent . '                                <li><a href="#"><img src="img/icones/culture/culture50.png" class="icones" data-toggle="tooltip" data-placement="bottom" title="Articles culturels"/></a></li>
';
        $buffer .= $indent . '                                <li><a href="#"><img src="img/icones/economic/economic50.png" class="icones" data-toggle="tooltip" data-placement="bottom" title="Articles economique"/></a></li>
';
        $buffer .= $indent . '                                <li><a href="#"><img src="img/icones/international/internat50.png" class="icones" data-toggle="tooltip" data-placement="bottom" title="Articles internationaux"/></a></li>
';
        $buffer .= $indent . '                                <li><a href="#"><img src="img/icones/mynews/mynews50.png" class="icones" data-toggle="tooltip" data-placement="bottom" title="My news"/></a></li>
';
        $buffer .= $indent . '                                <li><a href="#"><img src="img/icones/national/national50.png" class="icones" data-toggle="tooltip" data-placement="bottom" title="Articles nationaux"/></a></li>
';
        $buffer .= $indent . '                                <li><a href="#"><img src="img/icones/newstudents/newsstudents50.png" class="icones" data-toggle="tooltip" data-placement="bottom" title="News etudiants"/></a></li>
';
        $buffer .= $indent . '                                <li><a href="#"><img src="img/icones/numeric/numeric50.png" class="icones" data-toggle="tooltip" data-placement="bottom" title="Articles num' . "\0" . 'riques"/></a></li>
';
        $buffer .= $indent . '                                <li><a href="#"><img src="img/icones/politic/politic50.png" class="icones" data-toggle="tooltip" data-placement="bottom" title="Articles politiques"/></a></li>
';
        $buffer .= $indent . '                                <li><a href="#"><img src="img/icones/science/science50.png" class="icones" data-toggle="tooltip" data-placement="bottom" title="Articles scientifiques"/></a></li>
';
        $buffer .= $indent . '                                <li><a href="#"><img src="img/icones/society/society50.png" class="icones" data-toggle="tooltip" data-placement="bottom" title="Articles soci' . "\0" . 'tales"/></a></li>
';
        $buffer .= $indent . '                                <li><a href="#"><img src="img/icones/sport/sport50.png" class="icones" data-toggle="tooltip" data-placement="bottom" title="Articles sports"/></a></li>
';
        $buffer .= $indent . '                            </ul>
';
        $buffer .= $indent . '                        </nav>
...
';
        $buffer .= $indent . '                                <select id="tagFilter" class="form-control"></select>
';
        $buffer .= $indent . '                            </div>
';
        $buffer .= $indent . '                          </form>
...
';
        $buffer .= $indent . '                            <div class="form-group">
';
        $buffer .= $indent . '                              <input type="text" class="form-control" placeholder="Rechercher">
';
        $buffer .= $indent . '                            </div>
';
        $buffer .= $indent . '                            <button type="button" class="btn btn-default">GO</button>
';
        $buffer .= $indent . '                          </form>
';
        $buffer .= $indent . '                      </ul>
...
';
        $buffer .= $indent . '                                        <option>indifférent</option>
';
...
';
        $buffer .= $indent . '                        <span data-bind="foreach: anonymous">
';
        $buffer .= $indent . '                            <div class="col-sm-2 fadeInUp wowload article" tags="';
...
';
        $buffer .= $indent . '                                    <img class="img-responsive" id="grid_img" src="';
...
';
        $buffer .= $indent . '                                        <h3 id="grid_h3" data-bind="text: h3">';
        $value = $this->resolveValue($context->find('h3'), $context, $indent);
        $buffer .= call_user_func($this->mustache->getEscape(), $value);
        $buffer .= '</h3>
';
        $buffer .= $indent . '                                        <a  id="grid_h3Btn" title="';
        $value = $this->resolveValue($context->find('h3'), $context, $indent);
        $buffer .= call_user_func($this->mustache->getEscape(), $value);
        $buffer .= '" class="gallery-image btn btn-default showArticleDetails">Consulter</a>
';
        $buffer .= $indent . '                                    </div>
';
        $buffer .= $indent . '                                    <div class="extra">
';
        $buffer .= $indent . '                                        <p id="idMyact">';
        $value = $this->resolveValue($context->find('idMyact'), $context, $indent);
        $buffer .= call_user_func($this->mustache->getEscape(), $value);
        $buffer .= '</p>
';
        $buffer .= $indent . '                                        <p id="_id">';
        $value = $this->resolveValue($context->find('_id'), $context, $indent);
        $buffer .= call_user_func($this->mustache->getEscape(), $value);
        $buffer .= '</p>
';
        $buffer .= $indent . '                                        <p id="_rev">';
        $value = $this->resolveValue($context->find('_rev'), $context, $indent);
        $buffer .= call_user_func($this->mustache->getEscape(), $value);
        $buffer .= '</p>
';
        $buffer .= $indent . '                                        <p id="title">';
        $value = $this->resolveValue($context->find('h3'), $context, $indent);
        $buffer .= call_user_func($this->mustache->getEscape(), $value);
        $buffer .= '</p>
';
        $buffer .= $indent . '                                        <p id="img">';
        $value = $this->resolveValue($context->find('img'), $context, $indent);
        $buffer .= call_user_func($this->mustache->getEscape(), $value);
        $buffer .= '</p>
';
        $buffer .= $indent . '                                        <p id="content">';
        $value = $this->resolveValue($context->find('p'), $context, $indent);
        $buffer .= call_user_func($this->mustache->getEscape(), $value);
        $buffer .= '</p>
';
        $buffer .= $indent . '                                        <p id="source">';
        $value = $this->resolveValue($context->find('source'), $context, $indent);
        $buffer .= call_user_func($this->mustache->getEscape(), $value);
        $buffer .= '</p>
';
        $buffer .= $indent . '                                        <p id="myActName">';
        $value = $this->resolveValue($context->find('myActName'), $context, $indent);
        $buffer .= call_user_func($this->mustache->getEscape(), $value);
        $buffer .= '</p>
';
        $buffer .= $indent . '                                        <p id="views">';
        $value = $this->resolveValue($context->find('views'), $context, $indent);
        $buffer .= call_user_func($this->mustache->getEscape(), $value);
        $buffer .= '</p>
';
        $buffer .= $indent . '                                        <p id="tag">';
        $value = $this->resolveValue($context->find('tag'), $context, $indent);
        $buffer .= call_user_func($this->mustache->getEscape(), $value);
        $buffer .= '</p>
';
...
';
        $buffer .= $indent . '                                            <button type="button" class="btn btn-primary btn-block btn-flat">Connexion</button>
';
        $buffer .= $indent . '                                        </div><!-- /.col -->
';
        $buffer .= $indent . '                                    </div>
...
';
        $buffer .= $indent . '                    </div>
';
        $buffer .= $indent . '                    <div class="row hidden" id="profile-row">
';
        $buffer .= $indent . '                        
';
...
';
        $buffer .= $indent . '                            <img id="profilePicture" class="profile-user-img img-responsive img-circle" src="assets/dist/img/user4-128x128.jpg" alt="User profile picture">
';
        $buffer .= $indent . '                            <h3 class="profile-username text-center" id="profileUsername">Nina Mcintire</h3>
';
        $buffer .= $indent . '
';
...
';
        $buffer .= $indent . '                                <b>Abonnées</b> <a class="pull-right">1322</a>
';
        $buffer .= $indent . '                                </li>
';
        $buffer .= $indent . '                                <li class="list-group-item">
';
        $buffer .= $indent . '                                <b>Suivi</b> <a class="pull-right">543</a>
';
        $buffer .= $indent . '                                </li>
';
        $buffer .= $indent . '                                <li class="list-group-item">
';
        $buffer .= $indent . '                                <b>Amis</b> <a class="pull-right" id="profileNbFriends">1328</a>
';
        $buffer .= $indent . '                                </li>
';
        $buffer .= $indent . '                            </ul>
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '                            <a href="#" class="btn btn-primary btn-block"><b>Suivre</b></a>
';
...
';
        $buffer .= $indent . '        <!-- Modal -->
';
        $buffer .= $indent . '        <div class="modal fade" id="articleDetails" tabindex="-1" role="dialog" aria-labelledby="articleDetails">
';
...
';
        $buffer .= $indent . '                  <div class=\'user-block\'>
';
        $buffer .= $indent . '                    <img class=\'img-circle\' src=\'img/icones/anonymous/anonymous50.png\' alt=\'user image\'>
';
        $buffer .= $indent . '                    <span class=\'username\'><a href="#" id="source">Jonathan Burke Jr.</a></span>
';
        $buffer .= $indent . '                    <span class=\'description\'>Publie a - 7:30</span>
';
        $buffer .= $indent . '                  </div><!-- /.user-block -->
';
...
';
        $buffer .= $indent . '                    <img class="attachment-img" src="img/icones/anonymous/anonymous50.png" alt="attachment image" id="img">
';
        $buffer .= $indent . '                    <div class="attachment-pushed">
';
        $buffer .= $indent . '                      <h4 class="attachment-heading"><a href="http://www.lipsum.com/" id="h3">Lorem ipsum text generator</a></h4>
';
        $buffer .= $indent . '                      <div class="attachment-text" id="p">
';
        $buffer .= $indent . '                        Description about the attachment can be placed here.
';
        $buffer .= $indent . '                        Lorem Ipsum is simply dummy text of the printing and typesetting industry... <a href="#">more</a>
';
...
';
        $buffer .= $indent . '                    </div><!-- /.comment-text -->
';
        $buffer .= $indent . '                  </div><!-- /.box-comment -->
';
        $buffer .= $indent . '                  <div class=\'box-comment\'>
';
        $buffer .= $indent . '                    <!-- User image -->
...
';
        $buffer .= $indent . '                      <input type="text" class="form-control input-sm" placeholder="Appuyer sur entrer pour commenter">
';
        $buffer .= $indent . '                    </div>
';
        $buffer .= $indent . '                  </form>
