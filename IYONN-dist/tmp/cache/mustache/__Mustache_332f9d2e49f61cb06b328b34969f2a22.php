...
class __Mustache_332f9d2e49f61cb06b328b34969f2a22 extends Mustache_Template
{
...
';
        $buffer .= $indent . '        <div class="about">             <div class="overlay spacer text-center">             <div class="container">                 <h2><strong>My Actually</strong> , l\'actualité de différents médias sur une seule interface…</h2><br>                                  			Faire de l\'actualité un réseau social.<br> 			Pouvoir se partager les articles lus, créer des articles, laisser des commentaires et créer des échanges entre utilisateurs.<br> 			Avoir les articles triés par la communauté en fonction des thèmes souhaités.<br>             Des alertes par rapport à l\'actualité.<br>             Création de chaînes afin d\'être suivis par les utilisateurs.<br>             Permettre aux utilisateurs de devenir "porte-paroles" d\'un ou plusieurs thèmes.<br>             La géolocalisation donnera une proximité à l\'actualité en tout lieu et tout temps.<br>             Partager son avis et faire de cette plateforme le nouveau moyen d\'expression de l\'actualité mondiale.<br>                 </p>                 <h2><strongMy Actually : L\'actualité c\'est vous qui la faites !</strong></h2><br>                                  <div class="wowload fadeInUp social">                     <a href="https://www.facebook.com/myactually/?ref=hl" target="_blank">                         <i class="fa fa-facebook fa-2x"></i>                     </a>                     <a href="https://twitter.com/My_Actually" target="_blank">                         <i class="fa fa-twitter fa-2x"></i>                     </a>  			<a href="https://www.wizbii.com/project/profile/my-actually/my-actually" target="_blank">                         <i class="fa fa-share-alt-square fa-2x"></i> 	  		</a> 	                 </div>             </div>             </div>         </div>
';
